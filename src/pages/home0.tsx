...
const Home0: NextPage<IHomeProps> = (data) => {
            ...
            <div className="grids grid-avatar">
              <div className="avatar-container">
                <div className="avatar-outer">
                  <Image className="avatar" src="/images/logo.jpg" alt="logo" layout="responsive" width="100vh"
                         height="100vh"/>
                </div>
              </div>
            </div>
                  ...
                  <div className="timeline-item" key={exp.frontmatter.duration}>
                    <div className="left-part">
                      ...
                      <p className="timeline__place">
                        <a href={exp.frontmatter.url} target="_blank" rel="noreferrer noreferrer">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="grids grid-content">
              ...
              <p><a className="download-cv" href={data.metadata.pdf} target="_blank" rel="noopener noreferrer">Download
                CV</a></p>
